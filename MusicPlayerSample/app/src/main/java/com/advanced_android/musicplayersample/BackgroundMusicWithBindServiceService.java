...
public class BackgroundMusicWithBindServiceService extends Service {

    private static final String TAG = BackgroundMusicWithBindServiceService.class.getSimpleName();
